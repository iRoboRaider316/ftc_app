...
@Autonomous(name="cf_auto_blue_SIUC", group="LinearOpMode")

public class cf_auto_blue_SIUC extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        int drift;
        drift = (gyroSensor.getHeading() - 20);
        if (drift < 0){
            drift = drift * -1;
        }
        ...
        // Drive backward 1 in to get past the line
        distance = 1;
        maxSpeed = .4;
        direction = -1;
        drive(distance, maxSpeed, direction, parallel - drift);
