...
@Autonomous(name="cf_endzones_Red", group="LinearOpMode")
//@Disabled

public class cf_endzones_Red extends LinearOpMode {
...
//
//        while (!gamepad1.a){
//            telemetry.addLine("Review selection and press a to confirm");
//            if (center)
//                telemetry.addLine("Parking center");
//            else if (ramp)
//                telemetry.addLine("Parking ramp");
//            else
//                telemetry.addLine("Playing Defense");
//            telemetry.update();
//        }
//        telemetry.clear();
